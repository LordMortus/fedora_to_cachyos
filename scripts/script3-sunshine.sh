...
EOF
    ...
    niri)
        ...
        echo "Sunshine will automatically select the best capture method for your GPU."
        ;;
...
echo "  To save config changes you must use an SSH tunnel (CSRF protection"
echo "  blocks saves from any origin other than localhost):"
echo ""
...
echo "  1. Open https://localhost:47990 via tunnel in your browser"
