...
echo ""
echo " Detected environment: $COMPOSITOR"
echo ""
if [ "$COMPOSITOR" = "kde" ]; then
echo " Web UI: https://localhost:47990"
echo " Open that URL directly in a browser on this machine."
echo ""
...
echo " Web UI access (headless — no local browser available):"
echo " Use an SSH tunnel from your Windows machine:"
echo ""
echo "   ssh -L 47990:localhost:47990 $(whoami)@<vm-ip>"
echo ""
echo " Then open https://localhost:47990 in your Windows browser."
echo " (Ignore the self-signed SSL warning)"
echo ""
echo " First-time setup:"
echo "  1. Open the SSH tunnel, then open https://localhost:47990"
echo "  2. Create your admin username and password"
echo "  3. Complete Niri compositor setup (see niri-sunshine-setup.txt)"
echo "  4. In Sunshine web UI, set capture method to: portal"
echo "  5. In Moonlight on your client, add this PC"
echo "  6. Enter the PIN shown in Moonlight when prompted"
fi
echo ""
...
if [ "$COMPOSITOR" = "niri" ] || [ "$COMPOSITOR" = "headless" ]; then
echo "  - Niri compositor session (needed for Sunshine to capture)"
fi
echo ""
